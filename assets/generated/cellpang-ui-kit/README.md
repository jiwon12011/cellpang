...
- `loading-main-cell-village.png`: main/loading screen illustration.
- `icons/`: 30 individually cropped transparent UI icon PNG files.

These files are additive and do not replace the existing production assets.
